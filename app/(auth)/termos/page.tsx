  ...
  return (
    ...
    >
      <div className="highlight-box">
        ...
        e o ObrasFlow. Eles definem os direitos e obrigações de ambas as partes, o que é permitido
        ...
        funcionalidade do ObrasFlow, você declara, sob sua responsabilidade, que:</strong>
      ...
      <p>
        O <strong>ObrasFlow</strong> é uma plataforma digital especializada em gestão de obras,
        ...
        seus titulares legais, doravante denominados simplesmente "<strong>ObrasFlow</strong>",
        "<strong>nós</strong>", "<strong>nos</strong>" ou "<strong>nosso</strong>".
      </p>
      <p>
        A plataforma é acessível exclusivamente por meio do domínio oficial do ObrasFlow na internet,
      ...
      <p>
        ...
        da plataforma ObrasFlow — seja como responsável pela conta da empresa, como membro convidado
      ...
      <ul>
        <li>
          <strong>Plataforma:</strong> O sistema ObrasFlow como um todo — incluindo a interface web
          ...
          outra ferramenta disponibilizada pelo ObrasFlow, seja ela gratuita ou paga.
        </li>
        <li>
        ...
        <li>
          ...
          ObrasFlow. Esta conta serve para manutenção do sistema, suporte técnico avançado,
        ...
        <li>
          <strong>Empresa / Tenant:</strong> Cada empresa cliente do ObrasFlow possui um ambiente
        ...
        <li>
          ...
          Atualmente, o ObrasFlow oferece três planos: <strong>Starter</strong>,
        ...
        <li>
          ...
          Usuário na plataforma. Esses dados pertencem ao Usuário, não ao ObrasFlow.
        </li>
        <li>
        ...
        <li>
          <strong>Integração:</strong> Conexão técnica entre o ObrasFlow e um serviço externo
      ...
      <p>
        Para utilizar o ObrasFlow, você precisa ter <strong>capacidade civil plena</strong>. Em
      ...
      <ul>
        ...
        <li>
          Não está proibido de utilizar o ObrasFlow por qualquer decisão judicial, administrativa
          ou contratual vigente.
        </li>
      </ul>
      <h3>3.3 Menores de Idade</h3>
      <p>
        O ObrasFlow é uma ferramenta profissional e não é destinado, em nenhuma hipótese, a
      ...
      <p>
        Para ter acesso às funcionalidades do ObrasFlow, é necessário criar uma conta. O processo
      ...
      <p>
        O ObrasFlow se reserva o direito de, a qualquer momento e sem necessidade de justificativa
      ...
      <p>
        ...
        para esse endereço. O ObrasFlow não se responsabiliza por problemas decorrentes de e-mail
      ...
      <p>
        A senha da sua conta é de <strong>sua responsabilidade exclusiva</strong>. O ObrasFlow
        jamais pedirá sua senha por e-mail, telefone, WhatsApp, chat ou qualquer outro canal.
        Se alguém solicitar sua senha alegando ser do ObrasFlow, trate isso como uma tentativa de
      ...
      <ul>
        ...
        <li>Não reutilize a senha do ObrasFlow em outros serviços;</li>
      ...
      <p>
        Cada pessoa física deve manter apenas uma conta no ObrasFlow. A criação de múltiplas contas
      ...
      <p>
        Este é um dos pilares de segurança do ObrasFlow. Cada empresa cadastrada existe em um
      ...
      <p>
        Cada plano do ObrasFlow permite um número máximo de usuários (perfis) ativos
      ...
      <p>
        O ObrasFlow é um serviço pago, oferecido por meio de assinaturas recorrentes (mensais ou
      ...
      <p>
        ...
        prestação de serviço de software, salvo indicação em contrário. O ObrasFlow pode oferecer
      ...
      <p>
        O ObrasFlow pode oferecer um período de avaliação gratuita ("trial") para novos
      ...
      <ul>
        ...
        <li>
          ...
          Stripe, plataforma certificada PCI-DSS nível 1. O ObrasFlow não armazena dados de
      ...
      <ul>
        <li>
          ...
          primeira cobrança, decidir que o ObrasFlow não atende às suas necessidades, solicitaremos
      ...
      <p>
        O ObrasFlow pode alterar os preços dos planos. Qualquer aumento de preço será comunicado
      ...
      <p>
        O ObrasFlow foi desenvolvido exclusivamente para uso profissional no contexto da gestão
      ...
      <p>Você pode usar o ObrasFlow para:</p>
      <ul>
      ...
      <ul>
        ...
        <li>
          ...
          outros usuários, empresas ou da própria infraestrutura do ObrasFlow sem autorização
        ...
        <li>
          ...
          plataforma ou nos sistemas do ObrasFlow;
        </li>
        <li>
        ...
        <li>
          ...
          desproporcionalmente a infraestrutura do ObrasFlow, prejudicando outros usuários;
        </li>
        <li>
      ...
      <div className="highlight-box">
        ...
        autoriza o ObrasFlow a: (1) suspender ou encerrar imediatamente a conta sem aviso prévio
      ...
      <p>
        ...
        seu</strong>. O ObrasFlow não reivindica propriedade sobre nenhum dos dados, documentos,
        fotos, relatórios ou informações que você inserir. Você é o proprietário integral do seu
        conteúdo.
      </p>
      <p>
        O que concedemos ao ObrasFlow é apenas uma <strong>licença de uso técnica e operacional</strong>
      ...
      <h3>7.2 O ObrasFlow Não Usa Seus Dados para Fins Comerciais</h3>
      <p>
      ...
      <p>
        ...
        carregar ou compartilhar na plataforma. O ObrasFlow não monitora, revisa, edita ou aprova
      ...
      <p>
        Embora não monitoremos o conteúdo dos usuários de forma proativa, o ObrasFlow se reserva
      ...
      <p>
        Toda a tecnologia, design e identidade do ObrasFlow são resultado de muito trabalho e
      ...
      <p>
        São de propriedade exclusiva do ObrasFlow ou de seus licenciadores, e estão protegidos pelas
        leis brasileiras e internacionais de propriedade intelectual:
      </p>
      <ul>
        <li>A marca "ObrasFlow", o logo, o logotipo e toda a identidade visual da plataforma;</li>
        ...
        <li>A documentação técnica, guias de uso, materiais de treinamento e qualquer conteúdo produzido pelo ObrasFlow;</li>
        <li>As integrações e APIs desenvolvidas pelo ObrasFlow.</li>
      </ul>
      <p>
      ...
      <p>
        É expressamente proibido, sem autorização prévia e escrita do ObrasFlow: (i) reproduzir
        ou copiar a interface, design ou qualquer elemento visual da plataforma; (ii) criar
        produtos ou serviços derivados ou concorrentes baseados na tecnologia do ObrasFlow; (iii)
        usar a marca ObrasFlow de qualquer forma que possa causar confusão ou associação indevida;
      ...
      <p>
        O ObrasFlow se compromete a envidar seus melhores esforços técnicos e operacionais para
      ...
      <p>O ObrasFlow não se responsabiliza por interrupções causadas por:</p>
      <ul>
      ...
      <p>
        O ObrasFlow está em constante evolução. Isso significa que, ao longo do tempo, poderemos:
      </p>
      <ul>
      ...
      <h3>10.1 Suspensão por Iniciativa do ObrasFlow</h3>
      <p>
        O ObrasFlow pode suspender ou encerrar uma conta — temporária ou definitivamente — nos
      ...
      {/* 11 */}
      <h2><span className="num">11</span> Limitação de Responsabilidade do ObrasFlow</h2>
      <p>
        O ObrasFlow é uma ferramenta de gestão e organização de informações. Não somos responsáveis
      ...
      <p>
        Especificamente, o ObrasFlow <strong>não se responsabiliza</strong> por:
      </p>
      <ul>
        <li>
        ...
        <li>
          ...
          qualquer outro serviço externo integrado que estejam fora do controle do ObrasFlow;
        </li>
        <li>
          <strong>Danos indiretos e consequenciais:</strong> Quaisquer danos que não sejam
          consequência direta e imediata de uma falha comprovada do ObrasFlow.
        </li>
      </ul>
      <p>
        Em qualquer caso, a responsabilidade total do ObrasFlow perante o Usuário fica limitada
      ...
      <div className="info-box">
        ...
        O ObrasFlow é uma ferramenta de apoio à gestão — não um substituto para o julgamento
      ...
      <p>
        O ObrasFlow pode oferecer a possibilidade de integrar a plataforma com serviços externos
      ...
      <ul>
        <li>
          A integração pode envolver o tráfego de dados entre o ObrasFlow e o serviço externo.
        ...
        <li>
          ...
          serviço externo</strong>, que são independentes dos termos do ObrasFlow. É sua
          responsabilidade ler e aceitar esses termos;
        </li>
        <li>
          O ObrasFlow não se responsabiliza por falhas, indisponibilidades, mudanças ou
        ...
        <li>
          ...
          serviço externo, não pelo ObrasFlow.
        </li>
      </ul>

      {/* 13 */}
      <h2><span className="num">13</span> Confidencialidade Mútua</h2>
      <h3>13.1 Compromisso do ObrasFlow</h3>
      <p>
        O ObrasFlow trata todas as informações dos clientes como estritamente confidenciais. Nossos
      ...
      <p>
        Ao utilizar o ObrasFlow, você poderá ter acesso a informações técnicas, comerciais ou
        operacionais do ObrasFlow que não são de domínio público — como características do sistema,
      ...
      <p>
        A segurança dos seus dados é uma prioridade absoluta no ObrasFlow. Implementamos múltiplas
        camadas de proteção:
      </p>
      ...
      <ul>
        ...
        <li><strong>Senhas com hash:</strong> Senhas são armazenadas exclusivamente em formato hash irreversível com bcrypt (fator de custo mínimo 12). Nenhum funcionário do ObrasFlow tem acesso à sua senha real — nem nós mesmos conseguimos recuperá-la, apenas redefini-la;</li>
      ...
      <p>
        Ao criar uma conta, você concorda em receber comunicações do ObrasFlow por e-mail e por
      ...
      <p>
        ...
        constituem o <strong>acordo completo e integral</strong> entre você e o ObrasFlow sobre
      ...
      <p>
        Se o ObrasFlow deixar de exercer algum direito previsto nestes Termos em uma situação
        ...
        representante autorizado do ObrasFlow.
      </p>
      <h3>17.4 Cessão</h3>
      <p>
        O Usuário não pode ceder, transferir ou delegar seus direitos ou obrigações decorrentes
        destes Termos a terceiros sem prévia autorização escrita do ObrasFlow. O ObrasFlow pode
      ...
      <p>
        O ObrasFlow não será responsabilizado por atrasos, falhas ou descumprimento de obrigações
        ...
        governamentais que impeçam a operação normal. Nesses casos, o ObrasFlow notificará os
      ...
      <p>
        ...
        de suporte oficial do ObrasFlow. Acreditamos que a maioria dos problemas pode ser
