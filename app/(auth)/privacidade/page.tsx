  ...
  return (
    ...
    >
      ...
      <div className="highlight-box">
        ...
        sobre como o ObrasCitY trata seus dados pessoais: o que coletamos, por que coletamos, como
      ...
      <ul>
        <li>
          ...
          informações de conta, dados de uso): o <strong>ObrasCitY é o Controlador</strong>.
        ...
        <li>
          ...
          usuária) é o Controlador</strong> e o <strong>ObrasCitY atua como Operador</strong>,
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>Nome no cartão, últimos 4 dígitos, bandeira (armazenados pelo Stripe, não pelo ObrasCitY), endereço de cobrança</td>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>Usar dados como evidência em processos judiciais, administrativos ou arbitrais nos quais o ObrasCitY seja parte</td>
      ...
      <ul>
        ...
        <li>
          ...
          proporcionalidade para garantir que o interesse do ObrasCitY não prejudique
        ...
        <li>
          ...
          esperamos nunca ocorrer no contexto do ObrasCitY.
        </li>
      </ul>
      ...
      <p>
        Funcionários e colaboradores do ObrasCitY têm acesso apenas aos dados estritamente
      ...
      <ul>
        ...
        <li>
          ...
          nos quais o ObrasCitY seja parte, podemos usar dados como meio de prova;
        </li>
        <li>
      ...
      <h3>5.4 Em Caso de Venda ou Reestruturação do ObrasCitY</h3>
      <p>
        Se o ObrasCitY for adquirido, se fundir com outra empresa ou vender parte de seus ativos,
      ...
      <p>
        O ObrasCitY <strong>não utiliza</strong> cookies de publicidade (para mostrar anúncios),
      ...
      <p>
        ...
        O ObrasCitY não apenas cumpre esses direitos por obrigação legal — acreditamos genuinamente
      ...
      <p>
        <strong>O que é:</strong> Se você acreditar que o ObrasCitY violou algum dos seus
      ...
      <p>
        O ObrasCitY é uma plataforma de uso profissional e corporativo. <strong>Não é
      ...
      <p>
        ...
        dados ao ObrasCitY, entre em contato com nosso suporte imediatamente pelo canal de
      ...
      <p>
        Conforme exigido pelo art. 48 da LGPD, o ObrasCitY notificará a Autoridade Nacional de
      ...
      <p>
        A plataforma ObrasCitY pode conter links para sites externos ou oferecer integrações
        com serviços de terceiros. É importante que você saiba que:
      </p>
      <ul>
        <li>
          Ao clicar em um link para um site externo, você deixará a plataforma ObrasCitY e estará
        ...
        <li>
          O ObrasCitY não se responsabiliza pelo conteúdo, práticas de privacidade, políticas
