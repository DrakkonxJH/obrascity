...
const canais = [
  ...
  },
  {
    ...
    contato: "comercial@obrasflow.com",
  },
  {
    ...
    contato: "onboarding@obrasflow.com",
  },
];
      ...
      <div className="of-inline-header" style={{ marginBottom: 20, alignItems: "flex-start" }}>
        <div>
          ...
          <p className="of-empty-text">
            Central de atendimento e orientacoes praticas para sua equipe usar o ObrasFlow com
