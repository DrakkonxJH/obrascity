...
const FEATURE_MIN_PLAN: Record<PlanFeature, "starter" | "pro" | "enterprise"> = {
  ...
  financeiro_avancado: "enterprise",
  integração_whatsapp: "enterprise",
  integração_sheets: "enterprise",
  integração_zapier: "enterprise",
  automacoes_workflow: "enterprise",
  gestão_documentos: "enterprise",
  comunicação_integrada: "enterprise",
  segurança_enterprise: "enterprise",
