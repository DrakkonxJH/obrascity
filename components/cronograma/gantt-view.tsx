  ...
  return (
    <div className="of-gantt-wrapper">
      ...
      >
        ...
        <div className="of-gantt-months" style={{ gridTemplateColumns: `repeat(${colCount}, 1fr)` }}>
        ...
        {items.map((item) => (
          ...
          >
            ...
            <div className="of-gantt-timeline-cell" style={{ position: "relative", height: 48, overflow: "hidden" }}>
              <div className="of-gantt-grid-cols" style={{ gridTemplateColumns: `repeat(${colCount}, 1fr)` }}>
                {months.map((month, index) => (
